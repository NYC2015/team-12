	...
	*/
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo (!empty($title) ? '<div class="ign-text-container" style="color: '.$text_color.'"><h3 style="color: '.$text_color.'">'.$title.'</h3>' : '');
			echo (!empty($text) ? '<div class="ign-content-text" style="color: '.$text_color.'">'.$text.'</div></div>' : '');
